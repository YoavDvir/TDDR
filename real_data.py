...
class TDDTR:
    ...
    def readatgc(self):
        ...
        atgcfile = "ATGC" + self.atgcnum + "reduced.csv"
    ...
    def program_end(self):
        ...
        atgcpng = "atgc" + self.atgcnum + ".png"
        tatgc.render(atgcpng, w=183, units="mm")
        print(tatgc)
        print(self.atgcnum, "TDD,ATGC,UNIMOG,SGC", round(d01, 3), round(d02, 3), round(d03, 3), round(d12, 3),
              round(d13, 3),
              round(d23, 3), "max:", maxdis)
